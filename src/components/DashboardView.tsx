...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  // Get a few featured/new recipes safely
  const featuredRecipes = (recipes || []).filter(r => r && r.featured).slice(0, 4);
  ...
  // Respaldo seguro para evitar errores si no hay un nombre definido
  const safeName = (userName || 'Glower').trim();

...
export default function App() {
  ...
  // Estados protegidos con fallbacks seguros en caso de datos vacíos o corruptos
      ...
      <main className="flex-1 p-6">
        ...
        {currentTab === 'shopping' && (
          <SmartShoppingList 
            ...
            onToggleShoppingItem={(id) => setShoppingList(prev => prev.map(i => i.id === id ? {...i, completed: !i.completed} : i))}
            onDeleteShoppingItem={(id) => setShoppingList(prev => prev.filter(i => i.id !== id))}
